...
export PATH="$PATH$LOCAL_SCRIPTS_PATH$FLUTTER_PATH$ANDROID_PLATFORM_TOOLS_PATH$ANDROID_EMULATOR_PATH$ANDROID_TOOLS_PATH$ANDROID_TOOLS_BIN_PATH$GO_PATH$KOTLINC_PATH$SPICETIFY"
